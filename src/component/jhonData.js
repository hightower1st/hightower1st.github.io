  ...
  service: [
    {
      ...
      serviceTitle: "Financial Services",
      sDetails:
      ...
      menuItems: [
        {
          id: 1,
          icon: "icon_pin_alt",
          text: "9036 N. 14th Drive | Phoenix, Arizona 85021",
        },
        {
          id: 2,
          icon: "icon_phone",
          text: "Phone: +1.602.400.4503",
        },
        {
          id: 3,
          icon: "icon_mail",
          text: "Email: hightower1st@cox.net",
        },
        // {
        //   id: 4,
        //   icon: "icon_globe",
